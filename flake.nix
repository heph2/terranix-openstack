{
  description = "terranix openstack cloud module";
  inputs = {
      ...
      (system:
        let
          ...
          terranixOptions = terranix.lib.terranixOptions {
            ...
            urlPrefix = "https://github.com/heph2/terranix-openstack/tree/main/module";
        ...
        in
          {
            ...
            terranixModules.openstack = import ./default.nix;
            terranixModule.imports = [ self.terranixModules.openstack ];
          };
}
